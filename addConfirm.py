...
import isbnlib,urllib
import DBcall
import datetime
import sys
class Ui_addConfirm(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setPixmap("repository/cover/"+isbn+".jpg")
        self.label.setScaledContents(True)
        self.lineEdit.setText(isbn)
        self.lineEdit_2.setText(ti)
        self.lineEdit_3.setText(au[0])
        self.lineEdit_4.setText(p)
        self.lineEdit_5.setText(lan)
        self.lineEdit_6.setText(y)
    ...
    def confirm(self):
        ...
        file.close()
        self.label_2.setText("Book Added!!!")
