...
class Ui_ChangePassword(object):
    def setupUi(self, ChangePassword):
        ...
        self.label_st.setGeometry(QtCore.QRect(140, 20, 61, 21))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, ChangePassword):
        ChangePassword.setWindowTitle(QtGui.QApplication.translate("ChangePassword", "Form", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_st.setText(QtGui.QApplication.translate("ChangePassword", "YES!", None, QtGui.QApplication.UnicodeUTF8))


if __name__ == "__main__":
    import sys
    app = QtGui.QApplication(sys.argv)
    ChangePassword = QtGui.QWidget()
